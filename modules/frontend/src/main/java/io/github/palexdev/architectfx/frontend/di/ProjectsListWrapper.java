...
@Bean
@Wrapper
public class ProjectsListWrapper implements Supplier<ObservableList<Project>> {
    //================================================================================
    // Properties
    //================================================================================
    ...
    // Constructors
    //================================================================================
    public ProjectsListWrapper(AppSettings settings) {
        projects = FXCollections.observableArrayList(settings.loadProjects());
    }
