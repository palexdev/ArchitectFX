...
public class TestMavenHelper {
    ...
    void testDownloadArtifacts() {
        ...
        Path[] paths = new Path[]{
            ...
            MavenHelper.MAVEN_LOCAL.resolve("io/github/palexdev/mfxcore/11.8.0/mfxcore-11.8.0.jar"),
            MavenHelper.MAVEN_LOCAL.resolve("io/github/palexdev/mfxlocalization/11.1.0/mfxlocalization-11.1.0.jar"),
            MavenHelper.MAVEN_LOCAL.resolve("io/github/palexdev/mfxresources/11.9.1/mfxresources-11.9.1.jar"),
